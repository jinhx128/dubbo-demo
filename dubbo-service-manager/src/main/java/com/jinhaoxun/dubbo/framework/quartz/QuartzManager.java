package com.jinhaoxun.dubbo.framework.quartz;
...
public class QuartzManager {
     ...
     * quartz任务类包路径
     */
    private static String jobUri = "com.jinhaoxun.acservice.quartz.job.";
    ...
    public void addSimpleJob(AddSimpleJobServiceReq addSimpleJobServiceReq, String taskId) throws Exception {
        ...
        try {
            ...
            // 转换为时间差，秒单位
            int time = (int)Duration.between(addSimpleJobServiceReq.getDate(), LocalDateTime.now()).toMillis();
