package com.jinhaoxun.dubbo.vo.http;
...
@Setter
@Getter
public class HttpResponse<T extends ActionResponse> extends Model {
	/**
	 * 响应码
	 */
	...
	* @return
	 */
	public static <T extends ActionResponse> HttpResponse<T> build(Integer code, String msg, T data){
	...
	* @return
	 */
	public static <T extends ActionResponse> HttpResponse<T> buildSuccess(String msg, T data){
	 ...
	 * @return
	 */
	public static <T extends ActionResponse> HttpResponse<T> buildSuccess(T data){
	...
	* @return
	 */
	public static <T extends ActionResponse> HttpResponse<T> buildSuccess(){
