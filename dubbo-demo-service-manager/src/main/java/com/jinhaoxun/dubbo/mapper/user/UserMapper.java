...
public interface UserMapper extends BaseMapper<User> {
     ...
     */
    Long selectIdByPhone(String phone) throws Exception;
     ...
     * @return ResponseResult 用户id
     */
    Long selectIdByEmail(String email) throws Exception;
     ...
     */
    Boolean selectBan(Long userId) throws Exception;
     ...
     */
    Boolean selectStatus(Long userId) throws Exception;
     ...
     */
    int updateStatus(Long userId) throws Exception;
     ...
     */
    int updatePassword(@Param("userId") Long userId, @Param("password") String password) throws Exception;
     ...
     */
    int updateBan(@Param("userId") Long userId, @Param("ban") Boolean ban) throws Exception;
