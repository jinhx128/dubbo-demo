...
import com.jinhaoxun.dubbo.module.websocket.model.request.AllRequestMessage;
import com.jinhaoxun.dubbo.module.websocket.model.request.ChatRequestMessage;
...
public class WebSocketBusiness {
     ...
     * @throws Exception
     */
    @HystrixCommand(fallbackMethod = "messageHandlingFallBack")
     ...
     * @throws Exception
     */
    public void messageHandlingFallBack(ChatRequestMessage chatRequestMessage) throws Exception {
    }
     ...
     * @throws Exception
     */
    @HystrixCommand(fallbackMethod = "messageHandlingAllFallBack")
     ...
     * @throws Exception
     */
    public void messageHandlingAllFallBack(AllRequestMessage allRequestMessage) throws Exception {
    }
}
